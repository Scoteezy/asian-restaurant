...
const AdminPage = () => {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Добро пожаловать в рабочую панель</h2>
        <p className="text-muted-foreground">
          Здесь вы можете управлять заказами и меню
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Для получения помощи по использованию рабочей панели обратитесь к документации или в службу поддержки.
          </p>
          <p className="text-sm text-muted-foreground">
