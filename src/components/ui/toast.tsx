...
const toastVariants = cva(
  ...
  justify-between space-x-2 overflow-hidden rounded-md border p-4 pr-6 shadow-lg 
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    className={cn(
      ...
      focus:ring-ring disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-muted/40 
